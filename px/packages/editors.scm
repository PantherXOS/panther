...
(define-public vscode
  (package
    ...
    (inputs `(("vscode" ,(make-vscode-release-asset version "vscode"
                          "0x4l7w98qn143pz20lfkzg808l25qbgdjrvxmz0ixih9vlh9x8d9"))
              ("gcc:lib" ,gcc "lib")
              ("gcc" ,gcc "lib")
              ("glib" ,glib)
              ("nss" ,nss)
...
(define-public cursor
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri "https://downloads.cursor.com/production/20adc1003928b0f1b99305dbaf845656ff81f5d4/linux/x64/deb/amd64/deb/cursor_2.2.44_amd64.deb")
       (sha256 (base32 "1mgmhzmhz4nn770613bx6cqrln0kyqa9mkk78rlsxbzq6kfz31lz"))))
    (build-system binary-build-system)
    (arguments
  ...
  (package
    ...
    (inputs `(("zed"
               ,(origin
                  ...
                  (sha256
                   (base32 "1v9q0c2kylvkbzygp9n5rmkwjxa71d7kv5sxczlfns1bcaqzw511"))))
              ("bash-minimal" ,bash-minimal)
              ("glib" ,glib)
              ("gtk+" ,gtk+)
              ("libx11" ,libx11)
