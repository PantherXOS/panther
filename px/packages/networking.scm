  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "09b53q28g2qls8i863kqg34rfww0433d2np3qx74i2hyp1wbsj5p"))))
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             "/v2ray-linux-64.zip"))
       (sha256
        (base32 "0lzd7ggqqvvgx19bxvgqgl0hcd4bls0llk4czhqqyy046w50m4k8"))))
    (build-system binary-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1nc803c9sybmrsravs87gs8798x2kda4cacw73y2833m97nhzwlp"))))
    (build-system binary-build-system)
    (arguments
