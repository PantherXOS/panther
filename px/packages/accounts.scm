...
;;; Hossein Ghaffari (h.ghaffari@pantherx.org)
...
(define-public px-accounts-service
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append "https://source.pantherx.org/px-accounts-service_v"
             version ".tgz"))
       (sha256
       ...
       #:phases (modify-phases %standard-phases
                  ...
                  (add-after 'install 'register-plugins
                    (lambda* (#:key inputs outputs #:allow-other-keys)
                      (define* (register-plugin plugin-name plugin-type
                                ...
                                (setenv "PYTHONPATH"
                                        (string-append target ":"
                                                       (getenv
                                                        "GUIX_PYTHONPATH")))))
                          #t))
                      (register-plugin (string-append ,name
                                                      "-plugin-python-test")
                       "python"
                       "src/px_accounts_service_plugin_python_test.py")
                      (register-plugin (string-append ,name
                                        "-plugin-test-public-service")
                       "python"
                       "src/px_accounts_service_plugin_test_public_service.py")
                      (register-plugin (string-append ,name "-plugin-cpp-test")
                                       "cpp")
                      (register-plugin (string-append ,name
                                                      "-plugin-cpp-custom")
                                       "cpp"))))))
...
(define-public px-accounts-matrix-bridge
  (package
    ...
    (description
     "Add support for Online Accounts integration for Matrix client library")
    (license license:expat)))
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "1kj84df95bmgy89k0mnxv8hy1l62b2xnyymkgz9rqs6882wk5lqx"))))
  ...
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append
             "https://source.pantherx.org/px-accounts-library-python_v"
             version ".tgz"))
       (sha256
    ...
    (arguments
     `(#:tests? #f))
    (propagated-inputs `(("python-pycapnp" ,python-pycapnp)
                         ("python-pyyaml" ,python-pyyaml)))
    (home-page "https://www.pantherx.org/")
    (synopsis "Client library and CLI tool for px-accounts-service")
    (description
     "Python library to work with online accounts service. plus a CLI tool")
    (license license:expat)))
...
(define-public px-accounts-service-providers-mail
  (package
    ...
    (arguments
     `(#:tests? #f))
    (propagated-inputs `(("px-accounts-service-plugin-imap" ,px-accounts-service-plugin-imap)
    ...
    (description
     "Collection of Official defined providers that Online Accounts Service
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "0asdq32diniz2xa7q19qhhcp52cyzsa5g5l81yi7rz12vmd814sb"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       ,#:phases
             ...
             (let* ((out (assoc-ref outputs "out"))
               ...
               (with-output-to-file (string-append regpath "/"
                 ...
                 (lambda _
                   (format #t regdata))))))
         (delete 'sanity-check))))
    (propagated-inputs `(("px-accounts-service-plugin-common" ,px-accounts-service-plugin-common)))
    (home-page "https://www.pantherx.org/")
...
(define-public px-oauth2-engine
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append "https://source.pantherx.org/px-oauth2-engine_"
                           version ".tgz"))
       (sha256
    ...
    (description
     "Collection of Official defined providers that Ocline Accounts Service
could load from store")
    (license license:expat)))
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "0jq81nrjslp4c2kz6vnrns13n65rx248ij28grrm7lkz4mbnb8y7"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       ,#:phases
             ...
             (let* ((out (assoc-ref outputs "out"))
               ...
               (with-output-to-file (string-append regpath "/"
                 ...
                 (lambda _
                   (format #t regdata))))))
         (delete 'sanity-check))))
    (propagated-inputs `(("px-online-sources-library" ,px-online-sources-library)
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_" version
                           ".tgz"))
       (sha256
        (base32 "0rmx12122l1hi1smayyf7a19ss2rg53ck2db8y6y0g27zxnzwz9n"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       ,#:phases
...
(define-public px-accounts-service-plugin-gitlab
  (package
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "1j82f3m3y52kcamv2pnipi5gb4h2yxisshq4r3nkb5ar0i8hyrp2"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
    ...
    (description
     "Adds support for GitLab accounts with access token to Accounts Service")
    (license license:expat)))
...
(define-public px-accounts-service-plugin-discourse
  (package
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_" version
                           ".tgz"))
       (sha256
        (base32 "0pgw46k20ms5nzsx79xydk7synqs1k617gk432grl1wcsy5a1hii"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
    ...
    (description
     "Adds support for Discourse accounts with access token to Accounts Service")
    (license license:expat)))
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "17cav8xracpnlxyxgimsjbxwxbn7g5gpm7446a3lsj5lrqjyy87m"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       ,#:phases
...
(define-public px-accounts-service-plugin-trojita
  (package
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             version ".tgz"))
       (sha256
        (base32 "0k4bybh56ff0d303ik5vnd371fzr8wcm25l79rmfbxv3rd32dxm2"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
    ...
    (description
     "Add or modify trojita account details using Online Accounts Service")
    (license license:expat)))
...
(define-public px-accounts-service-plugin-oauth2-github
  (package
    ...
    (description
     "Plugin to login, get github notifications and access to git account with OAUTH2 protocol.")
    (license license:expat)))
...
(define-public px-accounts-service-plugin-oauth2-mastodon
  (package
    ...
    (description
     "Plugin to login and access to mastodon account with OAUTH2 protocol.")
    (license license:expat)))
...
(define-public px-accounts-service-plugin-oauth2-google
  (package
    ...
    (description
     "Plugin to login and access to Google account with OAUTH2 protocol.")
    (license license:expat)))
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "0fvq8sqiph6hkwcz8ya93lr0wd2faczi6xi6vjbqqmwmzlx35xxn"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
                    ...
                    (lambda* (#:key inputs outputs #:allow-other-keys)
                      (substitute* (string-append "plugins/"
                        ...
                        (("PLUGIN_VERSION")
                         ,version))))
                  (delete 'sanity-check))))
    (propagated-inputs `(("python-pbkdf2" ,python-pbkdf2)
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "0zqaxfh2vks0a6wgh2qs9nf3dbprnvr8vyv3hq448wx5db9yrbyz"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
                      ...
                      (let* ((out (assoc-ref outputs "out"))
                        ...
                        (with-output-to-file (string-append regpath "/"
                          ...
                          (lambda _
                            (format #t regdata))))))
                  (delete 'sanity-check))))
    (propagated-inputs `(("python-botocore" ,python-botocore)
                         ("px-accounts-service-plugin-common" ,px-accounts-service-plugin-common)))
    (home-page "https://www.pantherx.org/")
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "11rs7jrx69798fr19byp9grqr4i3ym3hmwnffand36dh9niz8sz0"))))
    (build-system python-build-system)
    (propagated-inputs `(("python-pyqt" ,python-pyqt)
                         ("python-pyyaml" ,python-pyyaml)
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "0hgq3vwdcvswikf6ii4rhl6aykmb6rb2n7naa5m9s65zxsc1d7rk"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       ,#:phases
...
(define-public px-accounts-service-plugin-backup-local
  (package
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "0ycjd8gyd53s6hc7xvbf9bmswx53xa73pq2a4mhljavgcyldsakk"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
    ...
    (description
     "Adds support to save a password for
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "1zgl625ay8g8xlwc7bgchcd7yx9y43kjxnpgxxc90kg737lvaa54"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
                    ...
                    (lambda* (#:key outputs #:allow-other-keys)
                      (substitute* "plugins/px-accounts-service-plugin-activity-watch.yaml"
                        ...
                        (("PLUGIN_VERSION")
                         ,version))))
                  (delete 'sanity-check))))
    (propagated-inputs `(("px-accounts-service" ,px-accounts-service)
                         ("px-accounts-service-plugin-common" ,px-accounts-service-plugin-common)
...
(define-public px-accounts-service-plugin-maestral
  (package
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "0fsivz2mxzpgjpgspr3pggj8wjanvnmipwpj2hq7c7s3wqzd499i"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
    ...
    (description
     "Support Dropbox (Maestral) plugin for PantherX Online Accounts Service")
    (license license:expat)))
    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_v" version
                           ".tgz"))
       (sha256
        (base32 "16f9fzv57p4zb047wxj4d8kw49h9k3m8wi22bi9914svd7nh46dv"))))
    (build-system python-build-system)
    (arguments
     `(#:tests? #f
       #:phases (modify-phases %standard-phases
                    ...
                    (lambda* (#:key inputs outputs #:allow-other-keys)
                      (let* ((out (assoc-ref outputs "out"))
                             (regpath (string-append out
                                       "/etc/px/accounts/plugins")))
                        (mkdir-p regpath)
                        (call-with-output-file (string-append regpath "/"
                                                              ,name ".yaml")
                          (lambda (port)
                            (format port
