    ...
    (source
     (origin
       ...
       (uri (string-append "https://source.pantherx.org/" name "_" version
                           ".tgz"))
       (sha256
        (base32 "1xzr6b8f2478s81kngp8hd7qvvhx6nv6xja396sfhp78y04q5yw1"))))
...
(define-public px-wiki
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append "https://source.pantherx.org/wiki.pantherx.org_v"
                           version ".tgz"))
       (sha256
        (base32 "05j1fk64yph8z2irw7vfr225xvgp8zhax3vm9awpfi3hy2hsd07x"))))
    ...
    (description "PantherX Wiki - Offline html files.")
    (license license:expat)))
